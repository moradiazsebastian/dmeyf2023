...
PARAM$input$dataset <- "./datasets/competencia_02_FEH_v3.csv.gz"
...
PARAM$trainingstrategy$semilla_azar <- 167021 # Aqui poner su  primer  semilla

PARAM$hyperparametertuning$POS_ganancia <- 273000
PARAM$hyperparametertuning$NEG_ganancia <- -7000

# Aqui poner su segunda semilla
PARAM$lgb_semilla <- 288913
#------------------------------------------------------------------------------
