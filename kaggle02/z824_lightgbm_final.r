...
PARAM$finalmodel$optim$learning_rate <- 0.0203412596579522
PARAM$finalmodel$optim$feature_fraction <- 0.999699101877329
PARAM$finalmodel$optim$min_data_in_leaf <- 135
PARAM$finalmodel$optim$num_leaves <- 903
