...
PARAM$finalmodel$semilla <- 967913

# hiperparametros optimos
PARAM$finalmodel$optim$num_iterations <- 482
PARAM$finalmodel$optim$learning_rate <- 0.109547811875238
PARAM$finalmodel$optim$feature_fraction <- 0.755221228295407
PARAM$finalmodel$optim$min_data_in_leaf <- 40748
PARAM$finalmodel$optim$num_leaves <- 71
